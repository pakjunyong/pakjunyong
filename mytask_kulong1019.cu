...
/*쿨롱 힘만을 고려한 지속적인 힘 계산 (충돌 사이에도 적용)*/
...
/*주기적인 경계조건에 의한 충돌후 계의 모든립자들의 속도계산 */
